...
- **Status:** ✅ HABILITADO
- **URL Configurada:** `https://s2g-ticketing.preview.emergentagent.com/api/webhooks/jira`
- **URL Correta:** `https://s2g-ticketing.preview.emergentagent.com/api/webhooks/jira`
...
### Resultado do Teste:
```
POST https://s2g-ticketing.preview.emergentagent.com/api/webhooks/jira
...
3. **Atualize a URL:**
   - **URL Antiga:** `https://s2g-ticketing.preview.emergentagent.com/api/webhooks/jira`
   - **URL Nova:** `https://s2g-ticketing.preview.emergentagent.com/api/webhooks/jira`
