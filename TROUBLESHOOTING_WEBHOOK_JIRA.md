...
- [ ] 2. URL está **correta**: `https://readydata-access.preview.emergentagent.com/api/webhooks/jira`
...
2. Crie um novo webhook do zero:
   ...
   - **URL:** `https://readydata-access.preview.emergentagent.com/api/webhooks/jira`
