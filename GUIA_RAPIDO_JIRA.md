...
URL: https://projeto-evolucao-1.preview.emergentagent.com/api/webhooks/jira
...
3. Acesse Safe2Go: https://projeto-evolucao-1.preview.emergentagent.com/
4. Vá em **Casos**
...
**Teste manual:**
```bash
curl -X POST https://projeto-evolucao-1.preview.emergentagent.com/api/webhooks/jira \
...
**Endpoint do Webhook:**
```
POST https://projeto-evolucao-1.preview.emergentagent.com/api/webhooks/jira
```
